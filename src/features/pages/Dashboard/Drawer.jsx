        ...
        <div className="text-xl text-gray-100">
          ...
          <div>
            {tabs.map((tab, index) => (
             tab.route==="/dashboard"?
             <NavLink
             className={({ isActive }) => (isActive ? 'p-2.5 mt-2 flex items-center rounded-md px-4 bg-blue-600 duration-300 cursor-pointer  hover:bg-blue-600' : 'p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600')}
               key={index}
               to={tab.route}
               end
             >
